...
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_comment_info/'
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_order_detail/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_order_refund_info/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_cart_info/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_favor_info/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_coupon_use/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_payment_info/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_refund_payment/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dwd/dwd_order_info/'
TBLPROPERTIES ("parquet.compression"="lzo");
