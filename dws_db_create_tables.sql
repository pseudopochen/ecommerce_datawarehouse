...
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dws/dws_visitor_action_daycount'
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dws/dws_user_action_daycount/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dws/dws_sku_action_daycount/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dws/dws_coupon_info_daycount/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dws/dws_activity_info_daycount/'
TBLPROPERTIES ("parquet.compression"="lzo");
...
PARTITIONED BY (`dt` STRING)
STORED AS PARQUET
LOCATION '/mnt/gv0/brick/modules/hive/warehouse/gmall.db/dws/dws_area_stats_daycount/'
TBLPROPERTIES ("parquet.compression"="lzo");
